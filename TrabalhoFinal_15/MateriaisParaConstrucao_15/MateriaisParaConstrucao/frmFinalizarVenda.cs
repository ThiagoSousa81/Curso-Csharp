...
namespace MateriaisParaConstrucao
{
    public partial class frmFinalizarVenda : Form
    {
        ...
        //Método construtor que carregará os componentes do formulário frmVendas com os dados obtidos pelos parâmetros.
        ...
        /*Realiza o laço de repetição para percorrer as linhas do DataGrid dadosProdutos, passado por parâmetro ao construtor deste formulário,
         * para que no final seja exibido todos os itens da compra e um subtotal.*/
